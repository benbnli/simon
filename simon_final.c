/*
 * gcort002_jonei005_bli020_final_project.c
 *
 * Simon Game
 *
 * Created: 8/27/2017 1:36:26 PM
 * Authors: Jeremy O'Neill (jonei005), Gabriel F. Cortez (gcort002), Benjamin Li (bli020)
 */ 
...
const unsigned char max_length = 9;		// This global stores the game length. Once the player enters this many correct sequences, they win.
